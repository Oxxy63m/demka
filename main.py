...
# Что делает: показывает окно входа, после входа — каталог товаров и заказы.
# Сначала один раз выполнить: python create_db.py (создать БД).
# Подробнее — в ИНСТРУКЦИЯ.md
# =============================================================================
import os
import sys
